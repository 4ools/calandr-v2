...
## Features (current and coming)

- calendar showing workouts that will be coming up 💪
- details with a youtube link for each workout 📹
- ability to add event to your google calendar 📅
- button to open workout in a full screen responsive mode window, so can present and share specific window in google meet (not so important)
